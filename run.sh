...
if ! pidof "java" > /dev/null ; then
  ...
  java -jar -DfuTuApiIp=127.0.0.1 -Duser.timezone=Asia/Shanghai dingtou/start/target/dingtou.jar --spring.config.location=./config/application.yml > application.log
  RET=$?
